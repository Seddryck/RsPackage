...
namespace SsrsDeploy.Testing.Execution
{
    [TestFixture]
    public class ReportServiceTest
    {
        ...
        public void SetUp()
        {
            ...
            ProductCatalogPath = FileOnDisk.CreatePhysicalFile("ProductCatalog.rdl", "SsrsDeploy.Testing.Resources.Product Catalog.rdl");
